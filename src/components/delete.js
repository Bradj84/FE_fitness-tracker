...
//     return fetch(`https://fitness-dzmc.onrender.com/api/2211-ftb-et-web-pt/posts/${postID}`, {
//       method: 'POST',
//       headers: {
...
//     return fetch('https://fitness-dzmc.onrender.com/api/2211-ftb-et-web-pt/users/me', {
//       headers: {
//         'Content-Type': 'application/json',
//         'Authorization': `Bearer ${userToken}`
//       },
